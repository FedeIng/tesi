...
bot_admin=Bot_admin(admin['token'],admin['admins'])
print("Admin created")
...
bot_creation=Bot_creation(creation,tree)
print("Creation created")
getlink=database.get_getlink()
bot_getlink=Bot_getlink(getlink,tree)
print("Getlink created")
teacher=database.get_teacher()
bot_teacher=Bot_teacher(teacher,tree)
